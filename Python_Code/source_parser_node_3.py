    ...
    if (ser.isOpen()):
            ...
            if(message_indicator == "aa" or message_indicator == "55"):
                ...
                if  count == 5: 
                    ...
                    output_dic = source3.algorithm(node_id, opt_iter, input_dic)

                    input_dic['T_n'][1][:,opt_iter+1] = ( output_dic['T_n'][1][:,opt_iter+1]*1000 ).astype(int)  
                    input_dic['etaa'][1][:,opt_iter+1] = ( output_dic['etaa'][1][:,opt_iter+1]*1000 ).astype(int)  
                    input_dic['uss'][1][:,opt_iter+1] = ( output_dic['uss'][1][:,opt_iter+1]*1000 ).astype(int)  
                    input_dic['slacks_2'][1][:,opt_iter+1] = ( output_dic['slacks_2'][1][:,opt_iter+1]*1000 ).astype(int)  
                    input_dic['slacks'][1][:,opt_iter+1] = ( output_dic['slacks'][1][:,opt_iter+1]*1000 ).astype(int)  
                    # input_dic['Y_soln'][0][:,opt_iter] =   
                    input_dic['mu_cons2'][10:20,opt_iter+1] = ( output_dic['mu_cons2'][10:20,opt_iter+1]*100 ).astype(int)  
                    input_dic['mu_cons1'][1:2,opt_iter+1] = ( output_dic['mu_cons1'][1:2,opt_iter+1]*100 ).astype(int)  
                    input_dic['mu'][1:2,opt_iter+1] = ( output_dic['mu'][1:2,opt_iter+1]*100 ).astype(int)  

                    A['Node3'] = dummy
                    A['Node3'].message.decision_T[0:2] = input_dic['T_n'][node_id][:,opt_iter+1].astype(int).tolist()   
                    A['Node3'].message.eta = np.asscalar( input_dic['etaa'][node_id][:,opt_iter+1].astype(int) ) 
                    A['Node3'].message.uss = input_dic['uss'][node_id][:,opt_iter+1].astype(int).tolist()  
                    A['Node3'].message.slacks2 = input_dic['slacks_2'][node_id][:,opt_iter+1].astype(int).tolist()     
                    A['Node3'].message.slacks = input_dic['slacks'][node_id][:,opt_iter+1].astype(int).tolist()       
                    # A['Node1'].message.Y_soln[0:2] = input_dic['Y_soln'][node_id][:,opt_iter+1].astype(int).tolist()   
                    A['Node3'].message.mu_cons2 = input_dic['mu_cons2'][10:20,opt_iter+1].astype(int).tolist()     
                    A['Node3'].message.mu_cons1 = np.asscalar( input_dic['mu_cons1'][1:2,opt_iter+1].astype(int) )  
                    A['Node3'].message.mu = np.asscalar( input_dic['mu'][1:2,opt_iter+1].astype(int) )  
                    ...
                    if (ser.isOpen()):
                        ...
                        print "Wrote to serial port ( primal update: source 3 )"
                    opt_iter = opt_iter + 1
                ...
                if count == 10:
                    ...
                    output_dic = source3_dual.algorithm(node_id, opt_iter, input_dic)
                    ...
                    input_dic['T_n'][1][:,opt_iter] = ( output_dic['T_n'][1][:,opt_iter]*1000 ).astype(int)  
                    input_dic['etaa'][1][:,opt_iter] = ( output_dic['etaa'][1][:,opt_iter]*1000 ).astype(int)  
                    input_dic['uss'][1][:,opt_iter] = ( output_dic['uss'][1][:,opt_iter]*1000 ).astype(int)  
                    input_dic['slacks_2'][1][:,opt_iter] = ( output_dic['slacks_2'][1][:,opt_iter]*1000 ).astype(int)  
                    input_dic['slacks'][1][:,opt_iter] = ( output_dic['slacks'][1][:,opt_iter]*1000 ).astype(int)  
                    # input_dic['Y_soln'][0][:,opt_iter] =   
                    input_dic['mu_cons2'][10:20,opt_iter] = ( output_dic['mu_cons2'][10:20,opt_iter]*100 ).astype(int)  
                    input_dic['mu_cons1'][1:2,opt_iter] = ( output_dic['mu_cons1'][1:2,opt_iter]*100 ).astype(int)  
                    input_dic['mu'][1:2,opt_iter] = ( output_dic['mu'][1:2,opt_iter]*100 ).astype(int)  

                    A['Node3'] = dummy
                    A['Node3'].message.decision_T[0:2] = input_dic['T_n'][node_id][:,opt_iter].astype(int).tolist()   
                    A['Node3'].message.eta = np.asscalar( input_dic['etaa'][node_id][:,opt_iter].astype(int) ) 
                    A['Node3'].message.uss = input_dic['uss'][node_id][:,opt_iter].astype(int).tolist()  
                    A['Node3'].message.slacks2 = input_dic['slacks_2'][node_id][:,opt_iter].astype(int).tolist()     
                    A['Node3'].message.slacks = input_dic['slacks'][node_id][:,opt_iter].astype(int).tolist()       
                    # A['Node1'].message.Y_soln[0:2] = input_dic['Y_soln'][node_id][:,opt_iter+1].astype(int).tolist()   
                    A['Node3'].message.mu_cons2 = input_dic['mu_cons2'][10:20,opt_iter].astype(int).tolist()     
                    A['Node3'].message.mu_cons1 = np.asscalar( input_dic['mu_cons1'][1:2,opt_iter].astype(int) )  
                    A['Node3'].message.mu = np.asscalar( input_dic['mu'][1:2,opt_iter].astype(int) )     
                    ...
                    if (ser.isOpen()):
                        ser.write(motemessage2.build(parsed_data).encode('hex')+"\n")
                        print "Wrote to serial port ( dual update: source 3 )"
